...
/*
//criei um metodo estatico
    //nao precisa usar o new
    //quando criamos um metodo estatico, nao enxergamos o resto da classe
    //nao enxerga o this.todos =[];
    //somente usamos para passar informacao e retornar algo, classe auxiliar
    //nao teremos construtor, somente ajuda a executar algo
class Calculo {
    teste(valor){
        this.valor = valor;
        return this.valor;
...
console.log(Calculo.soma(2, 4));
console.log(Calculo.subtracao(2, 4));

const calculo = new Calculo();
console.log(calculo.teste("Teste"));
*/
